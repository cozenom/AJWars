...
public class Level2 extends StageBasedScreen implements InputProcessor{
    ...
    public void show() {
        ...
        skin.add("Resume", new Texture("ui/Resume_up.png"));
        skin.add("Resume_d", new Texture("ui/Resume_down.png"));
    ...
    public void pause() {
        ...
        Button resumeBtn = new Button(skin.getDrawable("Resume"), skin.getDrawable("Resume_d"));
